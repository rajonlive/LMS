<div>
    <table class="w-full table-auto">
        ...
        <tr>
            <td class="border px-4 py2">{{$lead->name}}</td>
            <td class="border px-4 py2">{{$lead->email}}</td>
            <td class="border px-4 py2">{{$lead->phone}}</td>
            <td class="border px-4 py2 text-center">{{date('F j, y', strtotime($lead->created_at))}}</td>
