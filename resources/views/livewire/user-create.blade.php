<form wire:submit.prevent="submitForm">
    <div class="flex -mx-4 mb-4">
        ...
        <div class="flex-1 px-4">
            ...
            <input wire:model.lazy="email" id="email" type="text" class="lms-input">
        ...
        <div class="flex-1 px-4">
            ...
            <input wire:model.lazy="password" id="password" type="text" class="lms-input">
    ...
    <div class="mb-4">
        <label for="role" class="lms-lable">Role</label>
